...
const Home = () => {
  return (
    <div  name="home" className='w-full h-screen bg-[#0a192f]'>
       ...
       <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>Aquib Khan</h1>
       <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0]'>I'm a MERN Stack Developer</h2>
       <p className='text-[#8892b0] py-4 max-w-[700px]'> I'm a MERN-stack developer specializing in building (and occasionally
