...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      <div>
        <img className='w-[70px] rounded-xl pt-1' src={logo} alt='Logo Image' />
      </div>
        ...
        <div className=' hidden lg:flex fixed top-[35%] left-0'>
          <ul>
            <li className='w-[160px] h-[60px] ml-[-100px] flex justify-between items-center hover:ml-[-10px] duration-300 bg-blue-600'>
